            ...
            <div class="lg:col-span-6 md:col-span-12 sm:col-span-12 lg:mt-0 md:mt-7">
                <div class="justify-center flex">
                    <div class="lg:w-[65%] lg:h-[80%] md:w-[65%] md:h-[80%] sm:w-[100%] sm:h-[100%] sm:mt-5  bg-white rounded-lg shadow-lg text-center">
                        ...
                        <form action="/save_register3" method="POST" class="lg:mt-9 sm:mt-5">
                            @csrf
                            <label for="username" class="flex justify-start lg:ml-12 sm:ml-7 sm:text-xs font-semibold">Masukan
                                Username</label>
                            <input class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 mt-2 sm:text-xs border-solid border-2 transition-all duration-200 ease-linear border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="text" name="username" id="username" placeholder="" />
                            @error('username')
                            <span class="mt-2 text-sm text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block">
                                {{$message}}
                            </span>
                            @enderror
                            <p class="font-semibold lg:mt-8 sm:mt-5 lg:ml-12 sm:ml-7 sm:text-xs text-start">
                                Masukan Alamat Toko
                            </p>
                            <p class="text-[#787878] text-start lg:ml-12 sm:ml-7 sm:text-xs lg:mt-4 sm:mt-2">Provinsi
                            </p>
                            <select name="provinsi" id="provinsi" class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 sm:text-xs border-solid border-2 mt-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]">
                            ...
                            @enderror
                            <br />
                            <div class="lg:flex lg:mt-4 sm:mt-2 justify-center gap-5 lg:ml-0 sm:pl-7 mb-5">
                                <div class="flex-col text-start sm:text-xs">
                                    <label for="kota" class="text-[#787878]">Kota</label> <br>
                                    <select name="kota" id="kota" class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-3 sm:mt-2 border-solid border-2 border-[#CCCCCC] rounded-lg lg:w-[170px] sm:w-[90%] focus:outline-[#D10B05]">
                                ...
                                <div class="flex-col text-start sm:text-xs sm:mt-3">
                                    ...
                                    <select name="kecamatan" id="kecamatan" class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-3 sm:mt-2 border-solid border-2 border-[#CCCCCC] rounded-lg lg:w-[170px] sm:w-[90%] focus:outline-[#D10B05]">
                            ...
                            <p class="text-[#787878] text-start lg:ml-12 sm:ml-7 sm:text-xs">Alamat Detail</p>
                            ...
                            <button type="submit" class="text-white sm:text-xs bg-[#D10B05] lg:py-3 sm:py-2 lg:px-40 md:px-36 sm:px-20 rounded-lg font-semibold my-10 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Daftar
                            </button>
                        </form>
                    </div>
