                ...
                <div class="justify-center flex">
                    <div
                        ...
                        <form action="/save_register3" method="POST" class="lg:mt-9 mt-5">
                            @csrf
                            <label for="username"
                                class="flex justify-start lg:ml-12 md:ml-11 sm:ml-7 sm:text-xs font-semibold">Masukan
                                Username</label>
                            <input
                                class="lg:pl-5 pl-2 lg:py-3 py-2 mt-2 sm:text-xs border-solid border-2 transition-all duration-200 ease-linear border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]"
                            ...
                            @enderror
                            <p
                                class="font-semibold lg:mt-8 md:mt-6 sm:mt-5 lg:ml-12 md:ml-11 sm:ml-7 sm:text-xs text-start">
                                Masukan Alamat Toko
                            </p>
                            <p
                                class="text-[#787878] text-start lg:ml-12 md:ml-11 sm:ml-7 sm:text-xs lg:mt-4 md:mt-3 sm:mt-2">
                                Provinsi
                            </p>
                            <select name="provinsi" id="provinsi"
                                class="lg:pl-5 pl-2 lg:py-3 py-2 sm:text-xs border-solid border-2 mt-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]">
                            ...
                            <br />
                            <div
                                class="lg:flex lg:mt-4 md:mt-3 sm:mt-2 justify-center gap-5 lg:ml-0 md:ml-11 sm:pl-7 mb-5">
                                <div class="flex-col text-start sm:text-xs">
                                    <label for="kota" class="text-[#787878]">Kota</label> <br>
                                    <select name="kota" id="kota"
                                        class="lg:pl-5 pl-2 lg:py-3 py-2 lg:mt-3 mt-2 border-solid border-2 border-[#CCCCCC] rounded-lg lg:w-[170px] md:w-[89%] sm:w-[90%] focus:outline-[#D10B05]">
                            ...
                            <textarea
                                class="peer block min-h-[auto] sm:text-xs mx-auto my-auto w-[80%] mt-3 mb-5 rounded border-2 bg-white border-solid border-[#CCCCCC] px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear"
                            ...
                            <button type="submit"
                                class="text-white sm:text-xs bg-[#D10B05] lg:py-3 py-2 lg:px-40 md:px-36 sm:px-20 rounded-lg font-semibold my-10 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Daftar
                            </button>
                        </form>
                    </div>
