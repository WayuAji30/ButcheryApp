    ...
    <div class="grid grid-cols-12">
        <div class="lg:col-span-8 col-span-12 sm:text-sm sm:px-3">
            <div class="lg:ml-24 md:ml-10">
                <a href="/cart" class="flex items-center gap-3 text-lg font-semibold hidden sm:block"><svg
                ...
                <button
                    class="text-[#D10B05] text-[20px] pb-4 md:pb-2 px-12 md:border-b-2 border-b-4 border-[#D10B05] font-medium cursor-default sm:hidden">
                    Checkout
                </button>
            </div>
            <div class="lg:ml-24 md:mx-10">
                ...
                <div class="w-[100%] bg-white border-b-4 border-[#e6e6e6] mt-8">
                    ...
                    <div class="list_produk flex items-center mt-3">
                        ...
                        <ul class="ml-6">
                            ...
                            <li class="font-semibold mt-4">Rp<span class="harga_barang"
                                    id="harga_barang">{{$dp->harga}}</span><span
                                    class="qty font-semibold ml-3 sm:text-sm" id="qty">x{{$dp->qty}}</span></li>
                        </ul>
                    </div>
                    @endforeach
                    <div class="mt-10"></div>
                ...
                <div class="w-[100%] bg-white border-b-4 border-[#e6e6e6] mt-8">
                    <div class="flex items-center justify-between lg:mr-8">
                        ...
                        <label for="my_modal_7" id="ubah_alamat"
                            class="text-[#D10B05] font-semibold hover:text-[#9F0804]"
                ...
                <div class="mt-3 ms-2">
                    ...
                    <p class="font-semibold mt-4" id="phone-user">
                        {{($data_user['no_hp'] === '') ?  '(+62) Tidak Tersedia' : $data_user['no_hp']}}</p>
                </div>
                <div class="mt-10"></div>
            </div>
