...
@section('content')   
      ...
      <div class="container mx-auto">
        <div class="grid grid-cols-12">
          ...
          <div class="col-span-4">
            <img
              src="{{asset('assets/img_index/asset/hiro/iklan/carosel1.svg')}}"
              alt=""
              class="mb-2 w-full"
            />
    ...
    <div class="w-full mt-16" id="fitur">
      <div class="container mx-auto">
        <div class="grid grid-cols-12 mx-14">
          <div class="lg:col-span-6 md:col-span-12 gap-14 flex">
            <!-- 1 -->
            <form action="">
              <button
          ...
          <div class="lg:col-span-6 md:col-span-12 lg:gap-14 md:gap-8 flex">
            <!-- 5 -->
            <form action="">
              <button
                class="px-3 py-[5px] rounded-lg items-center hover:bg-[#D10B05] hover:text-white hover:border-[#D10B05]"
            ...
            <form action="">
              <button
                class="px-8 py-[5px] rounded-lg items-center hover:bg-[#D10B05] hover:text-white hover:border-[#D10B05]"
              >
                <svg
                  class="pr-2 ml-4"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex">
          <div class="flex items-center">
            ...
            <div class="flex gap-2 items-center">
              <p
                class="bg-[#FA4742] text-white py-2 px-3 rounded-lg font-semibold"
                id="hour"
              >
                00
              </p>
        ...
        <div class="container mt-9">
          <div class="grid grid-cols-12 mx-auto items-center">
            <div class="col-span-3">
              <div
                class="bg-[#FA4742] w-full h-[336px] rounded-lg text-white pl-9 pt-12 relative"
              >
                ...
                <button
                  class="text-[#D10B05] bg-white px-4 py-2 rounded-full mt-6 font-bold"
                >
                  Selengkapnya
                </button>
            ...
            <!-- 1 -->
            <div class="col-span-2 absolute ml-[230px]">
              <a href="">
                <div
                  class="bg-white h-[272px] w-[215px] rounded-2xl drop-shadow-lg"
                >
                  ...
                  <div class="pt-3 pl-3">
                    ...
                    <div class="flex gap-2 items-center">
                      ...
                      <p
                        class="bg-[#F1C40F] bg-opacity-30 text-[#F1C40F] font-bold rounded-lg py-1 px-2"
                      >
                        24%
                      </p>
                    </div>
            ...
            <swiper-slide>
              <div class="flex mx-16 gap-8">
                ...
                <div class="col-span-2">
                  <a href="">
                    <div
                      class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2"
                    >
    ...
    <div class="w-full mt-20">
      <div class="container mx-auto px-[53px]">
        ...
        <div class="grid grid-cols-12 gap-10">
          ...
          <div class="col-span-3">
            <a href="" class="items-center flex">
              ...
              <span
                class="relative text-white text-[20px] font-semibold pl-8 block"
                >Daging Ikan</span
              >
            </a>
          </div>
          ...
          <div class="col-span-3">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/bebek.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/kerbau.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/kelinci.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3 mt-20">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/kambing.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3 mt-20">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/domba.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3 mt-20">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/udang.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3 mt-20">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/merpati.svg')}}"
                alt=""
                class="absolute"
              />
              <span
          ...
          <div class="col-span-3 mt-20">
            <a href="" class="items-center flex">
              <img
                src="{{asset('assets/img_index/asset/pilihanDaging/kerang.svg')}}"
                alt=""
                class="absolute"
              />
              <span
                class="relative text-white text-[20px] font-semibold pl-8 block"
                >Kerang dan Tiram</span
              >
            </a>
          </div>
          <!-- 12 -->
        ...
        <img
          src="{{asset('assets/img_index/asset/pilihanDaging/line.svg')}}"
          alt=""
          class="mt-28 justify-center"
        />
      </div>
    </div>
    <!-- Pilihan Daging -->
              ...
              >
                ...
                <div class="pt-3 pl-3">
                  ...
                  <p class="pt-5 flex text-[#999]">
                    <img
                      class="pr-2"
                      src="asset/card/clarity_store-solid.svg"
                      alt=""
                    />Culture Tambak
                  </p>
                  <p class="text-[#D10B05] font-medium flex">
                    <img
                      class="pr-2"
                      src="asset/card/solar_point-on-map-bold.svg"
                      alt=""
                    />Bekasi Timur
                  </p>
                  <p class="flex text-[#999]">
                    <img
                      class="pr-2"
                      src="asset/card/ic_round-star.svg"
                      alt=""
