    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-4">
                <img src="{{asset('assets/img_index/asset/hiro/iklan/carosel1.svg')}}" alt="" class="lg:mb-2 sm:mb-[3px] w-full lg:block md:block hidden" />

                <img src="{{asset('assets/img_index/asset/hiro/iklan/smallDown.svg')}}" alt="" class="w-full lg:block md:block hidden" />
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container mx-auto lg:block md:hidden sm:hidden">
        <div class="grid grid-cols-12 lg:mx-14 md:mx-14">
            <div class="lg:col-span-6 md:col-span-12 sm:col-span-12 lg:gap-14 md:gap-14 flex">
                <!-- 1 -->
                <form action="">
                    <button class="px-3 py-[5px] rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
                ...
                <!-- 2 -->
                <form action="">
                    <button class="py-[5px] px-6 rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
                ...
                <!-- 3 -->
                <form action="">
                    <button class="px-5 py-[5px] rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
            ...
            <div class="lg:col-span-6 md:col-span-12 sm:col-span-12 lg:gap-14 md:gap-2 flex">
                <!-- 5 -->
                <form action="">
                    <button class="px-3 py-[5px] lg:mr-0 sm:mr-3 rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
                ...
                <!-- 6 -->
                <form action="">
                    <button class="px-8 py-[5px] lg:mr-0 md:mr-9 sm:mr-0 rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
                ...
                <!-- 7 -->
                <form action="">
                    <button class="px-5 py-[5px] lg:mr-0 md:mr-10 sm:mr-3 rounded-lg items-center hover:bg-[#D10B05] lg:text-base text-xs hover:text-white hover:border-[#D10B05] transition-all duration-200 ease-in-out">
        ...
        <div class="container lg:mt-9 md:mt-5 sm:mt-3 block md:hidden sm:hidden">
            <div class="grid grid-cols-12 mx-auto items-center">
                <div class="col-span-3">
                    <div class="bg-[#FA4742] lg:w-full md:w-[100%] h-[336px] rounded-lg text-white lg:pl-9 md:pl-5 pt-12 relative" data-aos="fade-right" data-aos-duration="600" data-aos-easing="ease-in-out" data-aos-once="true">
                                ...
                                <div class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2">
                                    ...
                                    <div class="pt-3 pl-3">
                                        ...
                                        <p class="pt-5 flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />Morning Raise Farm
                                        </p>
                                        <p class="text-[#D10B05] font-medium flex">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/solar_point-on-map-bold.svg')}}" alt="" />Jakarta Selatan
                                        </p>
                                        <p class="flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/ic_round-star.svg')}}" alt="" /><span class="pr-1">4.9</span> |
                            ...
                            <a href="">
                                <div class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2">
                                    ...
                                    <div class="pt-3 pl-3">
                                        ...
                                        <p class="pt-5 flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />Eternity Farm
                                        </p>
                                        <p class="text-[#D10B05] font-medium flex">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/solar_point-on-map-bold.svg')}}" alt="" />Bogor Utara
                                        </p>
                                        <p class="flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/ic_round-star.svg')}}" alt="" /><span class="pr-1">4.8</span> |
                            ...
                            <a href="">
                                <div class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2">
                                    ...
                                    <div class="pt-3 pl-3">
                                        ...
                                        <p class="pt-5 flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />Abadi Jaya Farm
                                        </p>
                                        <p class="text-[#D10B05] font-medium flex">
                            ...
                            <a href="">
                                <div class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2">
                                    ...
                                    <div class="pt-3 pl-3">
                                        ...
                                        <p class="pt-5 flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />Makmur Berkah Farm
                                        </p>
                                        <p class="text-[#D10B05] font-medium flex">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/solar_point-on-map-bold.svg')}}" alt="" />Jakarta Utara
                                        </p>
                                        <p class="flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/ic_round-star.svg')}}" alt="" /><span class="pr-1">5.0</span> |
                            ...
                            <a href="">
                                <div class="bg-white h-[335px] w-[228px] rounded-2xl drop-shadow-lg mb-2">
                                    ...
                                    <div class="pt-3 pl-3">
                                        ...
                                        <p class="pt-5 flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />Sentosa Farm
                                        </p>
                                        <p class="text-[#D10B05] font-medium flex">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/solar_point-on-map-bold.svg')}}" alt="" />Depok
                                        </p>
                                        <p class="flex text-[#999]">
                                            <img class="pr-2" src="{{asset('assets/img_index/asset/card/ic_round-star.svg')}}" alt="" /><span class="pr-1">5.0</span> |
...
<div class="w-full lg:mt-20 md:mt-10 sm:mt-4 ">
    <div class="container mx-auto lg:px-[53px] md:px-12 px-5">
        ...
        <div class="grid grid-cols-12 lg:gap-10 sm:gap-2">
            ...
            <div class="lg:col-span-3 col-span-6 ">
                <a href="" class="items-center flex lg:mt-5 md:mt-20 group">
                    ...
                    <div class="absolute w-[310px] h-[129px] rounded-xl bg-gradient-to-r from-[#d10b05] opacity-0 group-hover:opacity-100 transition-all duration-500 sm:hidden">
                    </div>
        ...
        <img src="{{asset('assets/img_index/asset/pilihanDaging/line.svg')}}" alt="" class="mt-28 justify-center lg:block hidden" />
    </div>
</div>
<!-- Pilihan Daging -->
                ...
                <a href="/produk/{{$rp['_id']}}">
                    <div class="bg-white h-[344px] sm:h-[280px] w-[207px] sm:w-[155px] rounded-2xl drop-shadow-lg border-white border-2 hover:border-[#D10B05] hover:border-2 transition-all duration-200 ease-linear">
                        ...
                        <div class="pt-3 pl-4">
                            ...
                            <p class="pt-5 flex text-[#999] sm:text-xs">
                                <img class="pr-2 sm:w-6" src="{{asset('assets/img_index/asset/card/clarity_store-solid.svg')}}" alt="" />{{$rp['nama_toko']}}
                            </p>
