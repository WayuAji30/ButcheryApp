        ...
        <div class="grid grid-cols-12 mx-14">
            ...
            <div class="lg:col-span-6 md:col-span-12 lg:gap-14 md:gap-8 flex">
                ...
                <form action="">
                    <button
                        class="px-3 py-[5px] rounded-lg items-center hover:bg-[#D10B05] hover:text-white hover:border-[#D10B05]">
                        <svg class="pr-2 ml-11" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                            viewBox="0 0 24 24">
                            <path fill="#d10b05"
                ...
                <form action="">
                    <button
                        class="px-5 py-[5px] rounded-lg items-center hover:bg-[#D10B05] hover:text-white hover:border-[#D10B05]">
                        <svg class="pr-2 ml-7" xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                            viewBox="0 0 512 512">
                            <path fill="#d10b05"
        ...
        <div class="container mt-9">
            <div class="grid grid-cols-12 mx-auto items-center">
                <div class="col-span-3">
                    <div class="bg-[#FA4742] w-full h-[336px] rounded-lg text-white pl-9 pt-12 relative">
                ...
                <div class="col-span-2 absolute ml-[230px]">
                    <a href="">
                        <div class="bg-white h-[272px] w-[215px] rounded-2xl drop-shadow-lg">
