    ...
    <div class="flex items-center justify-center">
        <div class="carousel-item">
            ...
            <form action="/searchProduct/bersetifikat">
                <button
                    class="sm:ml-3 px-3 py-[5px] rounded-lg items-center text-xs transition-all duration-200 ease-in-out">
        ...
        <div class="container lg:mt-9 md:mt-5 sm:mt-3 block md:hidden sm:hidden">
            <div class="grid grid-cols-12 mx-auto items-center">
                <div class="col-span-3">
                    <div class="bg-[#d10b05] lg:w-full md:w-[100%] h-[336px] rounded-xl text-white lg:pl-9 md:pl-5 pt-12 relative"
        ...
        <div class="grid grid-cols-12 lg:mt-9 mt-2 lg:gap-10 sm:gap-2">
            ...
            <div class="lg:col-span-2 md:col-span-4 lg:mt-0 md:mt-4 mt-3 sm:col-span-6">
                <a href="/produk/{{$rp['_id']}}">
                    <div id="card"
                        class="bg-white h-[344px] sm:h-[310px] w-full md:w-[90%] rounded-2xl drop-shadow-lg border-white border-2 hover:border-[#D10B05] hover:border-2 transition-all duration-200 ease-linear">
                        ...
                        <div class="pt-3 pl-2 ">
                            ...
                            <p class="flex text-[#999] sm:text-xs sm:mt-1">
                                ...
                                <span
                                    class="pl-1 pr-1">{{(isset($pd['jumlah_terjual']) ? $pd['jumlah_terjual'] : 0)}}</span>terjual
                            </p>
                        </div>
                    </div>
                </a>
