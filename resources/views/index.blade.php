        ...
        <div class="grid grid-cols-12 lg:mt-9 mt-2 lg:gap-10 sm:gap-2">
            ...
            <div class="lg:col-span-2 md:col-span-4 sm:col-span-6">
                <a href="/produk/{{$rp['_id']}}">
                    <div
                        class="bg-white h-[344px] sm:h-[280px] w-[207px] sm:w-[155px] rounded-2xl drop-shadow-lg border-white border-2 hover:border-[#D10B05] hover:border-2 transition-all duration-200 ease-linear">
