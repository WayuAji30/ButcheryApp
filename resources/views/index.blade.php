        ...
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-4">
                <img src="{{asset('assets/img_index/asset/hiro/iklan/carosel1.svg')}}" alt=""
                    class="lg:mb-2 sm:mb-[3px] w-full lg:block hidden" />
...
<div class="w-full lg:mt-16 sm:mt-3" id="fitur">
    <div class="container mx-auto lg:block sm:hidden">
...
<div class="carousel rounded-box lg:hidden md:hidden block">
...
<div class="w-full px-14 sm:px-3">
    <div class="container mx-auto mt-24 sm:mt-5">
        ...
        <div class="container mt-9 sm:mt-3 block sm:hidden">
        ...
        <div class="carousel rounded-box lg:hidden md:hidden block mt-3 flex items-center gap-3">
            <div class="carousel-item">
...
<!-- Pilihan Daging -->
<div class="w-full lg:mt-20 sm:mt-4 ">
    <div class="container mx-auto lg:px-[53px] px-5">
        <h1 class="text-[24px] font-medium lg:mb-20 sm:mb-10 sm:text-[16px]">Ngga Cuma Daging Sapi!</h1>
...
>>>>>>> 3c985a3979abc5544806e4185d4f49fc731299c8
        ...
        <div class="flex justify-center pt-12 lg:pb-32 sm:pb-10">
            <form action="">
                <button
                    class="border-solid border-2 border-[#D10B05] text-[#D10B05] font-semibold py-3 sm:py-2 px-24 sm:px-10 lg:rounded-xl rounded-lg lg:text-base text-xs hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear">
                    Lihat Lainnya
                </button>
            </form>
        </div>
