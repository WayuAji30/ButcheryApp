                ...
                <div class="flex items-center">
                    ...
                    <dialog id="my_modal_2" class="modal">
                        <div class="modal-box text-center">
                            ...
                            <form method="dialog">
                                <button class="border-2 py-2 w-full bg-[#D10B05] border-[#D10B05] text-white font-semibold rounded-md mt-8 hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-in-out">Tetap
                                    Di Halaman
                                    Ini</button>
                            </form>
                            <form action="/cart">
                ...
                <div class="lg:gap-3 md:gap-1 flex items-center" id="icon-bar">
                    <div class="dropdown dropdown-hover dropdown-bottom dropdown-end">
                        <label tabindex="0" class=" "><a class="flex items-center gap-2" id="profile" data-id="">
                                <img src="{{asset('assets/img_mitra_center/asset/navbar/profile.svg')}}" alt="" class="border-2 border-[#D10B05] rounded-full sm:w-8" />
