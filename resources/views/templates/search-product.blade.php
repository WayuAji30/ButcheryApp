    ...
    <nav class="fixed top-0 w-full z-50">
        ...
        <div class="bg-white drop-shadow-md">
            <div class="pt-6 pb-7 items-center justify-between flex lg:px-10 md:px-5">
                ...
                <img src="{{asset('assets/img_index/asset/navbar/pembatas.svg')}}" alt="pembatas" class="mx-4" />
                <div class="block">
                    <div class="flex gap-3">
                        <form action="/login">
                            <button
                                class="border-solid border-2 border-[#D10B05] font-semibold rounded-lg py-3 px-10 text-[#D10B05] hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear">
                                Masuk
                            </button>
                        </form>
                        <form action="/register">
                            <button
                                class="border-solid border-2 bg-[#D10B05] font-semibold rounded-lg py-3 px-10 border-[#D10B05] text-white mr-4 hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-linear">
                                Daftar
                            </button>
                        </form>
                    </div>
                ...
                <div class="hidden">
                    <div class="flex items-center gap-3">
                        <a href="" class="flex items-center gap-2"><img src="asset/navbar/profile.svg" alt="profile" />
                ...
                <div class="hidden">
                    <div class="flex items-center gap-8">
                        <a href="" class="flex items-center gap-2"><img src="asset/navbar/tokosaya.svg"
                                alt="tokosaya" />
                            <p class="font-semibold text-lg">Toko Saya</p>
                        </a>
                        <a href="profile/profile.html" class="flex items-center gap-2"><img
                                src="asset/navbar/profile.svg" alt="profile" />
                    ...
                    <div class="lg:col-span-4 md:col-span-6 lg:mt-0 md:mt-10 sm:col-span-12 sm:mt-10 md:ml-10">
                        ...
                        <div class="flex mt-5 items-center">
                            <button class="p-2 shadow-md rounded-lg" disabled>
                                <img src="{{asset('assets/img_index/asset/footer/qr.svg')}}" alt="qr" />
                            </button>
