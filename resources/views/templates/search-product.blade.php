        ...
        <div class="bg-white drop-shadow-md">
            <div class="pt-6 pb-7 items-center justify-between flex lg:px-10 md:px-5">
                ...
                <div class="gap-3 flex" id="icon-bar">
                    <a href="/cart/" class="p-1 rounded-lg hover:bg-gray-200 transition-all duration-300 ease-linear">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path fill="#454545"
                    ...
                    <a href="" class="p-1 rounded-lg hover:bg-gray-200 transition-all duration-300 ease-linear">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
