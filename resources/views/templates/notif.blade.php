        ...
        <div class="bg-white drop-shadow-md">
            <div class="lg:pt-6 py-3 lg:pb-7 items-center justify-between flex lg:px-10 md:px-14 px-2">
                ...
                <div class="flex lg:mr-0 sm:mr-1">
                    <form action="/searchProduct" method="get" id="seacrh">
                        <div class="relative flex items-center">
                            ...
                            <button class="absolute lg:right-7 right-2">
                                <svg id="search-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" class="sm:w-5">
                ...
                <div class="lg:gap-3 md:gap-2 sm:gap-1 lg:ml-0 md:ml-10 sm:ml-2 lg:mt-0 mt-1 flex" id="icon-bar">
                    ...
                    <a href="/cart/{{session('id_user')}}" class="py-1 px-2 rounded-lg hover:bg-gray-200 transition-all duration-200 ease-in-out">
                        <div class="relative inline-flex">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" class="sm:w-5">
                ...
                <div class="lg:block hidden">
                    <div class="flex items-center gap-8">
                        <a href="/daftarProduk/{{(isset($supplier->_id)) ? $supplier->_id : ''}}" class="flex items-center gap-2"><img src="{{asset('assets/img_index/asset/navbar/tokosaya.svg')}}" alt="" />
