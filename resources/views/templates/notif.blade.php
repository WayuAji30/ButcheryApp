...
<body class="lg:bg-[#f3f3f3]">
            ...
            <div class="bg-[#D10B05] py-4 lg:block hidden">
                <div class="mx-12 flex items-center justify-between">
                    ...
                    <div class="flex gap-5 items-center">
                        ...
                        @endif
                        <a href="/checkout_payment" class="text-white flex"><img src="{{asset('assets/img_index/asset/navbar/help.svg')}}" alt="" class="pr-1" />Bantuan
                        </a>
    ...
    'resources/js/product.js','resources/js/selectIndonesia.js', 'resources/js/drawer.js','resources/js/change_status.js'])
</body>
