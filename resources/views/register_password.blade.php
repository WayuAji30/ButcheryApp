                    ...
                    <div class="lg:w-[65%] lg:h-[80%] md:w-[65%] md:h-[80%] sm:w-[100%] sm:h-[100%] sm:mt-5 bg-white rounded-lg shadow-lg text-center">
                        ...
                        <form action="/save_register2" method="POST" class="lg:mt-9 sm:mt-5">
                            ...
                            <div class="relative md:mt-8">
                                <p class="text-start lg:ml-12 md:ml-11 sm:ml-7 font-semibold sm:text-xs">
                                    Buat Kata Sandi
                                </p>
                                <input class="pr-10 lg:pl-5 pl-2 lg:py-3 py-2 mt-2 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="password" name="password" id="password1" placeholder="" />
                                <button class="absolute lg:right-14 md:right-14 sm:right-8 btn-eye-close" form="none">
                                    <svg class="lg:mt-5 md:mt-4 sm:mt-3 sm:w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                ...
                                <button class="absolute lg:right-14 md:right-14 sm:right-8 btn-eye-open" form="none" hidden>
                                    <svg class="lg:mt-5 md:mt-4 sm:mt-3 sm:w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                                ...
                                @error('password')
                                <p class="mt-2 ml-12 text-start text-sm sm:text-xs text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block">
                                    {{$message}}
                                </p>
                                @enderror
                            </div>
                            <div class="relative lg:mt-8 md:mt-6 sm:mt-4">
                                <p class="text-start lg:ml-12 md:ml-11 sm:ml-7 font-semibold sm:text-xs">
                                    Konfirmasi kata sandi
                                </p>
                                <input class="pr-10 lg:pl-5 pl-2 lg:py-3 py-2 mt-2 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="password" name="confirm_password" id="password1" placeholder="" />
                            ...
                            <button class="button-submit2 text-white sm:text-xs bg-[#D10B05] lg:py-3 py-2 lg:px-36 md:px-32 sm:px-[70px] rounded-lg font-semibold lg:my-16 my-10 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Selanjutnya
                            </button>
                        </form>
                    </div>
