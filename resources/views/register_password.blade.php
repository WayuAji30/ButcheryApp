                ...
                <div class="justify-center flex">
                    <div
                        ...
                        <form action="/save_register2" method="POST" class="lg:mt-9 sm:mt-5">
                            ...
                            <button
                                class="text-white sm:text-xs bg-[#D10B05] lg:py-3 py-2 lg:px-36 md:px-32 sm:px-[70px] rounded-lg font-semibold lg:my-16 my-10 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Selanjutnya
                            </button>
                        </form>
                    </div>
