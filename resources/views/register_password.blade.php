                    ...
                    <div
                        ...
                        <form action="/save_register2" method="POST" class="lg:mt-9 sm:mt-5">
                            ...
                            <div class="relative md:mt-8">
                                ...
                                <input
                                    class="pr-10 lg:pl-5 pl-2 lg:py-3 py-2 mt-2 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]"
                                ...
                                <button class="absolute lg:right-14 md:right-14 sm:right-8 btn-eye-close" form="none">
                                    <svg class="lg:mt-5 md:mt-4 sm:mt-3 sm:w-5" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button class="absolute lg:right-14 md:right-14 sm:right-8 btn-eye-open" form="none"
                                    hidden>
                                    <svg class="lg:mt-5 md:mt-4 sm:mt-3 sm:w-5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <button
                                class="button-submit2 text-white sm:text-xs bg-[#D10B05] lg:py-3 py-2 lg:px-36 md:px-32 sm:px-20 rounded-lg font-semibold lg:my-16 my-10 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Selanjutnya
                            </button>
                        </form>
                    </div>
