            ...
            <div class="lg:ml-24 md:ml-5 sm:mx-2">
                ...
                <div class="w-[100%] md:w-[95%] bg-white border-b-4 border-[#e6e6e6] mt-11 cart-item">
                    <div class="flex items-center">
                        <input type="checkbox" class="harga-item checkbox checkbox-error mr-6"
                        ...
                        <input type="hidden" name="" id="id_supplier"
                            value="{{(isset($ci->supplier_id)) ? $ci->supplier_id : ''}}">
                        <input type="hidden" name="" id="id_produk"
                            value="{{(isset($ci->produk_id)) ? $ci->produk_id : ''}}">
