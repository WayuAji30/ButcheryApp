...
<div class="w-full h-screen bg-[#f3f3f3] overflow-x-hidden border-t flex flex-col">
    <div class="lg:mt-32 md:mt-24 bg-white rounded-2xl w-[97%] lg:ml-4 mx-3 shadow-md mb-5">
        <p class="mt-7">
            <a class="text-[#D10B05] lg:text-[20px] md:text-[18px] pb-4 lg:px-11 md:px-5 border-b-4 border-[#D10B05] font-medium cursor-default">Informasi
                Produk</a>
        </p>
        ...
        <form action="{{(isset($produk->_id) ? '/edit_produk' : '/store_produk')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex lg:ml-11 ml-5 lg:mt-10 md:mt-5 gap-10 items-center">
                <div>
                ...
                <div class="flex items-center lg:gap-9 md:gap-2 lg:ml-28 md:ml-14 md:mr-2">
                    <label for="foto1" class="cursor-pointer group">
                        <div class="foto-utama border-2 border-dashed border-[#ccc] rounded-xl lg:w-40 text-center group-hover:border-[#d10b05]">
                            <div class="flex justify-center md:px-10"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" class="mt-7">
            ...
            <div class="flex lg:ml-11 md:ml-5 md:mr-2 lg:mt-16 md:mt-5 md:justify-between items-center">
                <p class="font-semibold text-[18px] lg:mr-64">Nama Produk</p>
                <input name="nama_produk" type="text" placeholder="Ketikan Disini" value="{{(isset($produk->nama_produk)) ? $produk->nama_produk : ''}}" class="px-3 lg:py-4 md:py-3 border-solid border-2 border-[#CCCCCC] text-[#999] rounded-md lg:w-[547px] md:w-[410px] focus:outline-[#D10B05]" />
            </div>
            <div class="flex lg:ml-11 md:ml-5 lg:mt-10 md:mr-2 md:mt-5 md:justify-between items-center">
                <p class="font-semibold text-[18px] lg:mr-[300px]">Kategori</p>

                <select name="kategori" id="Kategori" class="px-3 lg:py-4 md:py-3 border-solid border-2 border-[#CCCCCC] text-[#999] rounded-md lg:w-[547px] md:w-[410px] focus:outline-[#D10B05]">
            ...
            <div class="flex lg:ml-11 md:ml-5 lg:mt-10 md:mt-5 md:mr-2 md:justify-between items-center">
                <div>
                    <p class="font-semibold text-[18px] lg:mr-[230px]">
                        Deskripsi Produk
                    </p>
                    <p class="mt-4">
            ...
            <div class="grid grid-rows-1 grid-flow-col lg:ml-11 md:ml-5 md:mr-2 mt-14">
                ...
                <div class="col-span-2">
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] md:ml-36 rounded-md">
            ...
            <div class="my-20">
                <div class="flex items-center gap-3 lg:justify-end md:justify-center lg:mr-[25%]">
