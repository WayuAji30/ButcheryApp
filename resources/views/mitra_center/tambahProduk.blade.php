        ...
        <form action="{{(isset($produk->_id) ? '/edit_produk' : '/store_produk')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-span-2 sm:mt-2">
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] w-80 md:ml-36 rounded-md">
                        <div class="lg:px-10 md:px-3 py-5">
                            ...
                            <input name="varian[harga1]" type="text" placeholder="Masukan dalam Rupiah" value="{{(isset($produk['varian'][0]['harga'])) ? $produk['varian'][0]['harga']: '' }}" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 sm:mt-2 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" />
                            <label for="" class="mr-10 sm:ml-3 sm:text-sm">Stok</label>
                            <input name="varian[stok1]" type="text" placeholder="Contoh: 17" value="{{(isset($produk['varian'][0]['stok'])) ? $produk['varian'][0]['stok']: '' }}" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 sm:mt-2 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" />
                        </div>
                    </div>
                </div>
                <div class="col-span-2 mt-5" id="varian-plus">
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] w-80 md:ml-36 rounded-md">
                        <div class="lg:px-10 md:pl-1 py-5 pembungkus-page" style="display: flex; align-items: center">
                            ...
                            <input hidden name="varian[harga2]" type="text" placeholder="Masukan dalam Rupiah" value="{{( isset($produk['varian'][1]['harga']) ) ? $produk['varian'][1]['harga'] : '' }}" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" />
                            <label for="" class="mr-10 sm:text-sm sm:ml-3" hidden>Stok</label>
                            <input hidden type="text" name="varian[stok2]" placeholder="Contoh: 17" value="{{( isset($produk['varian'][1]['stok']) ) ? $produk['varian'][1]['stok'] : '' }}" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" />
                        </div>
                    </div>
                </div>
                <div class="col-span-2 mt-5" id="varian-plus-3">
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] w-80 md:ml-36 rounded-md">
                        <div class="lg:px-10 md:pl-1 py-5 pembungkus-page-3" style="display: flex; align-items: center">
                            ...
                            <label for="" class="mr-[29px] sm:text-sm sm:ml-3" hidden>Harga</label>
                            <input hidden type="text" placeholder="Masukan dalam Rupiah" name="varian[harga3]" id="" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" value="{{( isset($produk['varian'][2]['harga']) ) ? $produk['varian'][2]['harga'] : '' }}" />
                            <label for="" class="mr-10 sm:text-sm sm:ml-3" hidden>Stok</label>
                            <input hidden type="text" placeholder="Contoh: 17" name="varian[stok3]" id="" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] sm:w-[70%] sm:text-sm focus:outline-[#D10B05]" value="{{( isset($produk['varian'][2]['stok']) ) ? $produk['varian'][2]['stok'] : '' }}" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="my-20 sm:mt-8 sm:mb-6">
                <div class="flex items-center gap-3 lg:justify-end md:justify-center sm:justify-end sm:mr-5 lg:mr-[25%]">
                    <button id="cancelButton" class="border-2 border-[#D10B05] text-[#D10b05] py-2 px-14 sm:px-5 sm:text-sm rounded-md font-semibold hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear">
                        Kembali
                    </button>
