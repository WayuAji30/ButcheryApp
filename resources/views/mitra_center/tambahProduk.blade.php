...
<div class="w-full h-screen bg-[#f3f3f3] overflow-x-hidden border-t flex flex-col">
    <div
        class="lg:mt-32 md:mt-24 mt-[75px] bg-white rounded-2xl sm:rounded-none w-[97%] sm:w-full lg:ml-4 sm:ml-0 mx-3 shadow-md mb-5 sm:mb-0">
        <p class="mt-7">
            <a
        ...
        <form action="{{(isset($produk->_id) ? '/edit_produk' : '/store_produk')}}" method="POST"
            ...
            <div
                ...
                <textarea
                    class="peer block min-h-[auto] lg:w-[547px] md:w-[410px] w-full sm:text-sm lg:h-64 md:h-40 mt-3 rounded-md border-2 bg-white border-solid border-[#CCCCCC] px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear peer-focus:text-primary focus:border-[#D10B05]"
