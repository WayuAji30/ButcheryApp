                ...
                <div class="col-span-2 mt-5" id="varian-plus">
                    <div class="bg-[#eeeeee] w-[547px] rounded-md">
                        <div class="px-10 py-5 pembungkus-page" style="display: flex; align-items: center">
                            ...
                            <button id="btn-tambah-produk" form="none" class="btn-tambah-produk flex items-center py-2 px-6 border-dashed border-2 border-[#D10B05] text-[#D10B05] font-semibold gap-3 rounded-md">
                ...
                <div class="col-span-2 mt-5" id="varian-plus-3">
                    <div class="bg-[#eeeeee] w-[547px] rounded-md">
                        <div class="px-10 py-5" style="display: flex; align-items: center">
                            ...
                            <button form="none" class="btn-tambah-produk flex items-center py-2 px-6 border-dashed border-2 border-[#D10B05] text-[#D10B05] font-semibold gap-3 rounded-md">
                                <span><img src="{{asset('assets/img_mitra_center/asset/tambahProduk/buttonPlus.svg')}}" alt="" /></span>
                                Tambah Varian
                            </button>
                            <input hidden type="text" placeholder="Contoh: 250gr" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] text-[#999] rounded-md w-[80%] focus:outline-[#D10B05]" />
                            <label for="" class="mr-[29px]" hidden>Harga</label>
                            <input hidden type="text" placeholder="Masukan dalam Rupiah" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] focus:outline-[#D10B05]" />
                            <label for="" class="mr-10" hidden>Stok</label>
                            <input hidden type="text" placeholder="Contoh: 17" class="px-3 py-2 border-solid border-2 border-[#e6e6e6] mt-4 text-[#999] rounded-md w-[80%] focus:outline-[#D10B05]" />
                        </div>
                    </div>
                </div>
            </div>
