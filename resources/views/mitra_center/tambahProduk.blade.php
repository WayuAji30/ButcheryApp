...
<div class="w-full h-screen bg-[#f3f3f3] overflow-x-hidden border-t flex flex-col">
    <div class="lg:mt-32 md:mt-24 mt-20 bg-white rounded-2xl w-[97%] lg:ml-4 sm:ml-1 mx-3 shadow-md mb-5">
        <p class="mt-7">
            <a
                class="text-[#D10B05] lg:text-[20px] md:text-[18px] pb-4 lg:px-11 px-5 border-b-4 border-[#D10B05] font-medium cursor-default">Informasi
                Produk</a>
        </p>
        ...
        <form action="{{(isset($produk->_id) ? '/edit_produk' : '/store_produk')}}" method="POST"
            ...
            <div class="flex sm:flex-wrap lg:ml-11 lg:mt-10 md:mt-5 mt-4 gap-10 sm:gap-2 items-center">
                <div>
                ...
                <div class="flex items-center lg:gap-9 gap-2 lg:ml-28 md:ml-14 md:mr-2 sm:ml-2">
                    <label for="foto1" class="cursor-pointer group">
                        <div
                            ...
                            <div class="flex justify-center md:px-10"><svg xmlns="http://www.w3.org/2000/svg" width="50"
                                    height="50" viewBox="0 0 50 50" fill="none" class="mt-7 sm:w-9 sm:mt-4">
                                    <path
            ...
            <div
                class="flex sm:flex-wrap lg:ml-11 md:ml-5 ml-2 md:mr-2 lg:mt-16 md:mt-5 mt-4 md:justify-between items-center">
                ...
                <input name="nama_produk" type="text" placeholder="Ketikan Disini"
                    ...
                    class="px-3 lg:py-4 md:py-3 py-2 sm:text-sm sm:mt-2 border-solid border-2 border-[#CCCCCC] text-[#999] rounded-md lg:w-[547px] md:w-[410px] w-80 focus:outline-[#D10B05]" />
            </div>
            <div
                class="flex sm:flex-wrap lg:ml-11 md:ml-5 ml-2 lg:mt-10 md:mr-2 md:mt-5 mt-4 md:justify-between items-center">
            ...
            <div
                class="flex sm:flex-wrap lg:ml-11 md:ml-5 ml-2 lg:mt-10 md:mt-5 mt-4 md:mr-2 md:justify-between items-center">
                <div>
                ...
                <textarea
                    class="peer block min-h-[auto] lg:w-[547px] md:w-[410px] w-80 sm:text-sm lg:h-64 md:h-40 mt-3 rounded-md border-2 bg-white border-solid border-[#CCCCCC] px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear peer-focus:text-primary focus:border-[#D10B05]"
                    ...
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] w-80 md:ml-36 rounded-md">
                        <div class="lg:px-10 md:pl-1 py-5 pembungkus-page" style="display: flex; align-items: center">
                            ...
                            <button id="btn-tambah-varian" form="none"
                                class="btn-tambah-produk sm:text-sm flex items-center py-2 px-6 sm:px-3 border-dashed border-2 border-[#D10B05] text-[#D10B05] font-semibold gap-3 rounded-md">
                    ...
                    <div class="bg-[#eeeeee] lg:w-[547px] md:w-[410px] w-80 md:ml-36 rounded-md">
                        <div class="lg:px-10 md:pl-1 py-5 pembungkus-page-3" style="display: flex; align-items: center">
                            ...
                            <button form="none" id="btn-tambah-varian3"
                                class="btn-tambah-varian-produk flex items-center py-2 px-6 sm:px-3 sm:text-sm border-dashed border-2 border-[#D10B05] text-[#D10B05] font-semibold gap-3 rounded-md">
                                <span><img src="{{asset('assets/img_mitra_center/asset/tambahProduk/buttonPlus.svg')}}"
                                        alt="" /></span>
                                Tambah Varian
                            </button>
