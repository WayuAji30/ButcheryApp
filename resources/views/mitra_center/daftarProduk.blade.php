                ...
                <tr class="border-b-2 border-slate-200"
                    ...
                    <td class="text-center sm:flex sm:flex-col sm:text-sm sm:gap-1">
                        <a href="/tambahProduk/{{$dp->_id}}"
                            class="border-2 border-[#D10B05] py-2 lg:px-10 md:px-4 px-3 rounded-md font-semibold text-[#D10B05] mr-2 hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear">
                            Edit
                        </a>

                        <!-- The button to open modal -->
                        <label for="my_modal_6"
                            class=" bg-[#D10B05] py-2 lg:px-8 md:px-3 px-3 sm:mr-2 rounded-md font-semibold text-white hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-linear btn-hapus"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="flex justify-center gap-10">
                                            <div class="modal-action">
                                                <label for="my_modal_6"
                                                    class="border-2 border-[#d10b05] rounded-md px-8 py-2 font-semibold text-[#d10b05] hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear cursor-pointer">Batal</label>
                                            </div>
