...
<div class="w-full h-screen bg-[#f3f3f3] overflow-x-hidden border-t flex flex-col">
    ...
    <div class="flex justify-center items-center">
        <div class="w-[460px] bg-white shadow-md rounded-md text-center">
            <svg class="mt-5 mx-auto my-auto" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                viewBox="0 0 40 40">
                <path fill="#d10b05"
            ...
            <form action="">
                <div class="flex justify-center gap-10  my-5">
                    <button
                        class="border-2 border-[#d10b05] rounded-md px-8 py-2 font-semibold text-[#d10b05]">Batal</button>
                    <button
                        class="border-2 border-[#d10b05] bg-[#d10b05] text-white px-8 py-2 rounded-md font-semibold">Hapus</button>
                </div>
            </form>
        </div>
    </div>
