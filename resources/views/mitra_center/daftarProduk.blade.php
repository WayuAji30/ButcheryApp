            ...
            <tbody>
                ...
                <tr class="border-b-2 border-slate-200">
                    ...
                    <td class="text-center">
                        <a href="/tambahProduk/{{(isset($dp['_id']) ? $dp['_id'] : '')}}" class="border-2 border-[#D10B05] py-2 px-10 rounded-md font-semibold text-[#D10B05] mr-2 hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-linear">
                            Edit
                        </a>
