            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <button class=" bg-[#D10B05] py-2 px-8 rounded-md font-semibold text-white hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-linear" onclick="my_modal_4.showModal()">Hapus
                        </button>
