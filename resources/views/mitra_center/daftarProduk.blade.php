    ...
    <div class="mt-32 bg-white rounded-tl-2xl w-full ml-4 shadow-md">
        ...
        <table class="table-auto w-full mt-5 mb-5" data-aos="fade-right" data-aos-duration="400" data-aos-easing="ease-in-out">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img src="{{asset('assets/img_mitra_center/asset/daftarProduk/sapi.png')}}" alt="" class="rounded-lg ml-5" />
                    </td>
                    ...
                    <td class="text-center">
                        ...
                        <button class=" bg-[#D10B05] py-2 px-8 rounded-md font-semibold text-white hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-linear" onclick="my_modal_4.showModal()">Hapus</button>
                        <dialog id="my_modal_4" class="modal">
                            <div class="flex justify-center items-center">
                                <div class="w-[460px] bg-white shadow-md rounded-md text-center">
                                    <svg class="mt-5 mx-auto my-auto" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 40 40">
