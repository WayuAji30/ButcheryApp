            ...
            <div class="grid justify-items-center md:mx-4">
                <div class="bg-white rounded-md lg:w-[80%] w-full shadow-md">
                    <div class="mt-7" id="logout">
                        <p class="">
                            <a
                                class="text-[#D10B05] text-[20px] pb-4 px-11 sm:px-4 sm:text-base border-b-4 border-[#D10B05] font-medium cursor-default">Profil
                                Saya</a>
                        </p>
                    </div>
                    ...
                    <div class="grid lg:grid-flow-col grid-flow-row lg:ml-20 lg:mt-16 mt-5">
                        <div class="row-span-3">
                            ...
                            <div class="md:flex md:justify-center md:gap-5">
                                <button
                                    class="py-2 px-4 lg:mt-11 mt-5 sm:ml-10 border-2 border-[#D10B05] rounded-md text-[#D10B05] font-semibold w-[280px] hover:bg-[#D10B05] hover:text-white transition-all duration-200 ease-in-out"
                                    id="profile-change-password">
                                    Ubah Kata Sandi
                                </button>

                                <button type="submit" id="submitEditProfile" disabled
                                    class="py-2 px-4 mt-5 sm:ml-10 border-2 border-[#ccc] bg-[#ccc] rounded-md text-white font-semibold w-[280px] transition-all duration-200 ease-in-out">
                                    Simpan Perubahan
                                </button>
                            </div>
                        </div>
                        <div class="mt-5 md:mt-14 md:ml-24">
                            <form action="/edit_profile" method="POST" id="form_edit_profile">
                                ...
                                <label for="username" class="font-semibold mr-6 sm:ml-3">Username</label> <br
                                    class="sm:block hidden">
                                <input type="text" placeholder="" name="username" id="username"
                                    value="{{$user->username}}"
                                    class="sm:ml-3 border-2 border-[#ccc] rounded-md w-[50%] sm:w-[90%] py-3 px-4 focus:outline-[#D10B05]" />
                                <br />
                                <label for="email" class="font-semibold mr-6 ml-8 sm:ml-3">Email</label><br
                                    class="sm:block hidden">
                                <input type="text" placeholder="rahmattahaluremik@gmail.com" name="email" id="email"
                                    value="{{(isset($user->email)) ? $user->email : ''}}"
                                    class="sm:ml-3 border-2 border-[#ccc] rounded-md w-[50%] sm:w-[90%] py-3 px-4 mt-5 focus:outline-[#D10B05]" />
                                <br />
                                <label for="no.hp" class="font-semibold mr-5 sm:ml-3">Nomor HP</label><br
                                    class="sm:block hidden">
                                ...
                                <div class="flex sm:flex-col">
                                    ...
                                    <div
                                        class="bg-white mt-5 sm:mt-0 rounded-md shadow-md w-[65%] sm:w-full sm:shadow-none sm:border-none border-2 border-slate-100 mb-20 sm:mb-5">
                                        <div class="mx-8 sm:mx-4">
                                            ...
                                            <div class="kecamatankota flex mt-4 lg:gap-12 md:gap-5 sm:gap-3 mb-5">
                                                <div class="flex-col">
                                                    <label for="kota" class="text-[#999]">Kota</label>
                                                    <select name="kota" id="kota"
                                                        class="pl-5 sm:pl-2 py-3 mt-3 border-solid border-2 border-[#CCCCCC] rounded-lg lg:w-[200px] sm:w-[160px] focus:outline-[#D10B05]">
                            ...
                            <form action="/ubah_Password" method="POST" id="ubahPassword" style="display: none;"
                                ...
                                <div class="relative flex items-center sm:mx-4">
                                    <input type="password" name="password" id="password"
                                        ...
                                        class="border-b-2 border-[#e6e6e6] w-[50%] sm:w-full pr-4 mt-8 focus:border-[#D10B05] focus:outline-none" />

                                    <button class="absolute right-[50%] sm:right-3 btn-eye-close" form="none">
                                        <svg class="mt-6" xmlns="http://www.w3.org/2000/svg" width="23" height="23"
                                            viewBox="0 0 24 24">
                                            <path fill="#b3b3b3"
                                ...
                                <div class="mt-12 mb-20 sm:mb-10 flex sm:justify-end sm:mr-4">
                                    <button id="cancelButton2" form="none"
                                        class="bg-[#D10B05] rounded-md text-white px-16 sm:px-10 py-2 mr-3 font-semibold hover:bg-[#9F0804]">
                                        Batal
                                    </button>
                                    <button id="saveButton"
                                        class="bg-[#ccc] rounded-md text-white px-16 sm:px-8 py-2 font-semibold">
                                        Simpan
                                    </button>
                                </div>
                            </form>
