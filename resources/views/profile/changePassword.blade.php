        ...
        <div class="col-span-12">
            <div class="grid justify-items-center">
                <div class="bg-white rounded-md w-[80%] shadow-md">
                    <p class="mt-7">
                        <a href="" class="text-[#D10B05] text-[20px] pb-4 px-11 border-b-4 border-[#D10B05] font-medium">Ubah
                            Kata Sandi</a>
                    </p>
                    ...
                    <div class="grid grid-rows-1 grid-flow-col ml-28 mt-16">
                        <div class="row-span-3">
                            ...
                            <form action="">
                                <input type="email" name="" id="" placeholder="Masukan Email Anda" required class="border-b-2 border-[#e6e6e6] w-[72%] pr-4 mt-8 focus:border-[#D10B05] focus:outline-none" />
                                ...
                                <div class="relative flex items-center">
                                    <input type="password" name="" id="" placeholder="Masukan Kata Sandi Baru" required class="border-b-2 border-[#e6e6e6] w-[72%] pr-4 mt-8 focus:border-[#D10B05] focus:outline-none" />

                                    <button class="absolute right-36 btn-eye-close" form="none">
                                        <svg class="mt-6" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                    ...
                                    <button class="absolute right-36 btn-eye-open" hidden form="none">
                                        <svg class="mt-6" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                                ...
                                <div class="mt-12 mb-20 flex">
                                    <button id="cancelButton" class="bg-[#D10B05] rounded-md text-white px-14 py-2 mr-3 font-semibold hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                        Batal
                                    </button>
                                    <button id="saveButton" class="bg-[#ccc] rounded-md text-white px-14 py-2 font-semibold hover:bg-[#D10B05] transition-all duration-200 ease-linear">
                                        Simpan
                                    </button>
                                </div>
                            </form>
