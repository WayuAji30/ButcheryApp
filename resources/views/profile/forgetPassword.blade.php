        ...
        <div class="col-span-12">
            <div class="grid justify-items-center">
                <div class="bg-white rounded-md w-[80%] shadow-md">
                    <p class="mt-7">
                        <a href="" class="text-[#D10B05] text-[20px] pb-4 px-11 border-b-4 border-[#D10B05] font-medium">Lupa
                            Password</a>
                    </p>
                        ...
                        <div class="row-span-3">
                            ...
                            <form action="">
                                ...
                                <div class="mt-12 mb-20 flex">
                                    ...
                                    <button id="saveButton" class="bg-[#ccc] rounded-md text-white px-14 py-2 font-semibold transition-all duration-200 ease-linear">
                                        Simpan
                                    </button>
                                </div>
                            </form>
