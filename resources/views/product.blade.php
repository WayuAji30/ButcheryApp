            ...
            <div class="lg:col-span-4 col-span-12">
                ...
                <div class="lg:block hidden">
                    ...
                    <div class="toko flex pl-16 mt-6 gap-4">
                        ...
                        <a href = "/toko/{{$detail_produk->supplier_id}}" id="fitur">
                            <button class="flex text-[#B3B3B3] py-2 px-6 border-2 border-[#B3B3B3] hover:border-[#D10B05] hover:text-[#D10B05] hover:bg-[#D10B05] hover:bg-opacity-10 items-center">
                                <svg class="pr-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
