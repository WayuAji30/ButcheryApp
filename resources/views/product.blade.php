    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-4 md:col-span-6 col-span-12 lg:mt-0 mt-5">
                ...
                <section class="mt-9 sm:mt-5">
                    ...
                    <div class="flex gap-3 mt-4">
                        <button id="low" data-varian="{{$detail_produk['varian'][0]['varian']}}" data-price="{{$detail_produk['varian'][0]['harga']}}" data-stok="{{$detail_produk['varian'][0]['stok']}}" class="py-2 px-4 rounded-lg border-2 border-gray-300 active transition-all duration-500 ease-in-out">
                            {{$detail_produk['varian'][0]['varian']}}
                        </button>
                        <button id="mid" data-varian="{{$detail_produk['varian'][1]['varian']}}" data-price="{{$detail_produk['varian'][1]['harga']}}" data-stok="{{$detail_produk['varian'][1]['stok']}}" class="py-2 px-4 rounded-lg border-2 border-gray-300 transition-all duration-500 ease-in-out">
                            {{$detail_produk['varian'][1]['varian']}}
                        </button>
                        <button id="high" data-varian="{{$detail_produk['varian'][2]['varian']}}" data-price="{{$detail_produk['varian'][2]['harga']}}" data-stok="{{$detail_produk['varian'][2]['stok']}}" class="py-2 px-4 rounded-lg border-2 border-gray-300 transition-all duration-500 ease-in-out">
                ...
                <div class="lg:hidden md:block">
                    ...
                    <div class="flex mt-6 gap-4">
                        <button class="flex text-[#D10B05] bg-[#D10B05] bg-opacity-10 py-2 sm:py-1 sm:px-4 px-6 border-2 border-[#D10B05] items-center sm:text-sm">
                ...
                <div class="mt-8 sm:mt-5">
                    ...
                    <div class="mt-5">
                        ...
                        <p class="flex mt-4">
                            ...
                            <select name="kota/kab" id="kota" class="font-medium md:w-48 sm:w-40">
            ...
            <div class="lg:col-span-4 md:col-span-6 sm:col-span-12 ml-8 sm:ml-0 lg:mt-0 md:mt-5">
                <div class="grid justify-items-center">
                    <div class="lg:w-[75%] w-[100%] h-[100%] sm:h-[10%] sm:rounded-none border-2 border-[#CCC] rounded-3xl sm:fixed sm:bottom-0 sm:bg-white">
