        ...
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-4 col-span-12">
                <div class="grid justify-items-center">
                    <img id="product-image" src="{{asset('storage/img_uploaded/'.$detail_produk['foto']['foto1'])}}"
                        alt="" class="w-[345px] rounded-md" />
                </div>
                <div class="flex gap-3 mt-4 lg:pl-16 lg:justify-normal md:justify-center">
                    <button
                        ...
                        <img src="{{asset('storage/img_uploaded/'.$detail_produk['foto']['foto1'])}}" alt=""
                            class="w-[61px] rounded-md" id="foto1" />
                    </button>
                    <button
                        class="border-4 border-white rounded-lg focus:border-[#d10b05] transition-all duration-500 ease-in-out"
                        onclick="changeProduct('{{$detail_produk['foto']['foto2']}}')">
                        <img src="{{asset('storage/img_uploaded/'.$detail_produk['foto']['foto2'])}}" alt=""
                            class="w-[61px] rounded-md" />
                    </button>
                    <button
                        class="border-4 border-white rounded-lg focus:border-[#d10b05] transition-all duration-500 ease-in-out"
                        onclick="changeProduct('{{$detail_produk['foto']['foto3']}}')">
                        <img src="{{asset('storage/img_uploaded/'.$detail_produk['foto']['foto3'])}}" alt=""
                            class="w-[61px] rounded-md" />
                    </button>
                </div>
                ...
                <div class="pl-16 mt-12 lg:block hidden">
                    ...
                    <button class="flex shadow-lg w-[328px] h-24 text-[12px] font-medium text-start mt-5">
                        <img src="{{asset('storage/img_uploaded/'.$pr['foto']['foto1'])}}" alt=""
                            class="w-[115px] h-[96px] h-24" />
                    ...
                    <div class="mt-5">
                        <p class="flex">
                            ...
                            <span class="font-semibold pl-1"
                                id="asal">{{$detail_produk['alamat_toko']['alamat']}}</span>
                        </p>
                        <p class="flex mt-4">
