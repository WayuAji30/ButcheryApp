                ...
                <div class="justify-center flex">
                    <div class="lg:w-[65%] lg:h-[80%] md:w-[65%] md:h-[80%] sm:w-[100%] sm:h-[100%] sm:mt-5 bg-white rounded-lg shadow-lg text-center">
                        ...
                        <form action="/auth_system" method="POST">
                            @csrf
                            <input class="lg:pl-5 pl-2 lg:py-3 py-2 lg:mt-9 mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="text" name="identifier" id="identifier" placeholder="No. Handphone/Email" />
                            ...
                            <div class="relative lg:mt-8 mt-2">
                                <input class="pr-10 lg:pl-5 pl-2 lg:py-3 py-2 lg:mt-2 mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="password" name="password" id="password1" placeholder="Password" />
                                <button class="absolute lg:right-14 md:right-14 right-9 btn-eye-close" form="none">
                                    <svg class="lg:mt-5 md:mt-5 mt-4 w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                ...
                                <button class="absolute lg:right-14 md:right-14 right-9 btn-eye-open" form="none" hidden>
                                    <svg class="lg:mt-5 md:mt-5 mt-4 w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                                ...
                                @if (session()->has('error'))
                                <p class="mt-2 text-start ml-12 text-sm sm:text-xs text-red-500 peer-[&:not(:placeholder-shown):not(:focus):invalid]:block">
                                    {{session('error')}}
                                </p>
                                @endif
                            </div>
                            ...
                            <button type="submit" class="button-submit text-white bg-[#D10B05] sm:text-xs lg:py-3 py-2 lg:px-40 md:px-36 sm:w-[80%] rounded-lg font-semibold lg:mt-8 md:mt-10 mt-4 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Masuk
                            </button>
                        ...
                        <div class="justify-center flex mb-10">
                            <form action="">
                                <button class="button bg-white border-[#CCC] border-2 sm:text-xs lg:py-3 md:py-3 sm:py-2 lg:px-[82px] md:px-16 sm:px-7 rounded-lg font-semibold mt-6 flex hover:border-[#d10b05] hover:text-[#d10b05] transition-all duration-200 ease-linear">
                                    <img src="{{asset('assets/img_index/asset/loginPage/google.svg')}}" alt="" class="lg:pr-3 pr-2 sm:w-6" />
                                    Masuk dengan Google
                                </button>
                            </form>
                        </div>
