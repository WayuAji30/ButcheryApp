                ...
                <div class="justify-center flex">
                    <div
                        ...
                        <form action="/auth_system" method="POST">
                            ...
                            <button type="submit"
                                class="text-white bg-[#D10B05] sm:text-xs lg:py-3 py-2 lg:px-40 md:px-36 sm:w-[80%] rounded-lg font-semibold lg:mt-8 md:mt-10 mt-4 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Masuk
                            </button>
