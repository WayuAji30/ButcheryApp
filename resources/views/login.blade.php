                ...
                <div class="justify-center flex">
                    <div
                        ...
                        <form action="/auth_system" method="POST">
                            @csrf
                            <input
                                class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-9 sm:mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]"
                            ...
                            <div class="relative lg:mt-8 sm:mt-2">
                                <input
                                    class="pr-10 lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-2 sm:mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]"
                                ...
                                <button class="absolute lg:right-14 sm:right-9 btn-eye-close" form="none">
                                    <svg class="lg:mt-5 sm:mt-4 sm:w-5" xmlns="http://www.w3.org/2000/svg" width="25"
                            ...
                            <button type="submit"
                                class="text-white bg-[#D10B05] sm:text-xs lg:py-3 sm:py-2 lg:px-40 md:px-36 sm:w-[80%] rounded-lg font-semibold lg:mt-8 sm:mt-4 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                Masuk
                            </button>
