        ...
        <div class="grid grid-cols-12 mt-9 sm:mt-4 lg:gap-10 sm:gap-2">
            ...
            <div class="lg:col-span-2 md:col-span-4 sm:col-span-6">
                <a href="/produk/{{$ds->_id}}">
                    <div class="bg-white lg:h-[344px] sm:h-[310px] lg:w-[207px] sm:w-[160px] rounded-2xl drop-shadow-lg border-white border-2 hover:border-[#D10B05] hover:border-2 transition-all duration-200 ease-linear">
                        <img src="{{asset('storage/img_uploaded/'.$ds['foto']['foto1'])}}" alt="" class="w-[228px] h-[130px] rounded-t-[15px]" />
                        <div class="pt-3 pl-2">
                            ...
                            <p class="text-[#D10B05] font-medium flex sm:text-xs sm:mt-1">
                                <img class="pr-2 sm:w-6" src="{{asset('assets/img_index/asset/card/solar_point-on-map-bold.svg')}}" alt="" />{{$ds['alamat_toko']['alamat']}}
                            </p>
