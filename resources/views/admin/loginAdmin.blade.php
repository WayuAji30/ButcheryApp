        ...
        <div class="grid grid-cols-12">
            ...
            <div class="lg:col-span-6 md:col-span-12 sm:col-span-12 lg:mt-0 md:mt-7">
                <div class="justify-center flex">
                    <div class="lg:w-[65%] lg:h-[80%] md:w-[65%] md:h-[80%] sm:w-[100%] sm:h-[100%] lg:mt-14 sm:mt-5 bg-white rounded-lg shadow-lg text-center">
                        <p class="font-semibold lg:text-[24px] md:text-[24px] sm:text-[18px] lg:mt-14 sm:mt-5">Halo
                            Admin!</p>
                        <form action="">
                            <input class="lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-9 sm:mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="text" name="identifier" id="identifier" placeholder="No. Handphone/Email" />
                            <div class="relative lg:mt-8 sm:mt-2">
                                <input class="pr-10 lg:pl-5 sm:pl-2 lg:py-3 sm:py-2 lg:mt-2 sm:mt-3 sm:text-xs border-solid border-2 border-[#CCCCCC] rounded-lg w-[80%] focus:outline-[#D10B05]" type="password" name="password" id="password1" placeholder="Password" />
                                <button class="absolute lg:right-14 sm:right-9 btn-eye-close" form="none">
                                    <svg class="lg:mt-5 sm:mt-4 sm:w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                ...
                                <button class="absolute lg:right-14 sm:right-9 btn-eye-open" form="none" hidden>
                                    <svg class="lg:mt-5 sm:mt-4 sm:w-5" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                            ...
                            <p class="lg:mt-3 sm:mt-2 text-end lg:pr-11 sm:pr-7 sm:text-xs">
                                <a href="/forgetPassword" class="text-[#D10B05] mt-3 hover:text-[#9F0804]">Lupa
                                    Password</a>
                            </p>
                            <form action="/adminProduk">
                                <button class="text-white bg-[#D10B05] sm:text-xs lg:py-3 my-10 sm:py-2 lg:px-40 md:px-36 sm:w-[80%] rounded-lg font-semibold lg:mt-8 sm:mt-4 hover:bg-[#9F0804] transition-all duration-200 ease-linear">
                                    Masuk
                                </button>
                            </form>
