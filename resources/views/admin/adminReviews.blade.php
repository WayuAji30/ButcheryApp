...
<aside class="relative pt-28 h-screen w-64 hidden lg:block md:block shadow-xl bg-white">
    <nav class="">
        ...
        <a href="/adminReviews" class="flex items-center active-nav-link cta-btn nav-item py-2 my-2 pl-5 nav-item border-l-4 border-[#d10b05]">
            <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                <path fill="#d10b05" d="M4 13v2h16v-2H4ZM4 2h16q.825 0 1.413.588T22 4v11q0 .825-.588 1.413T20 17h-4v5l-4-2l-4 2v-5H4q-.825 0-1.413-.588T2 15V4q0-.825.588-1.413T4 2Zm0 8h16V4H4v6Zm0 5V4v11Z" />
            </svg>
...
<<<<<<< HEAD
                        <input type="text" name="" id="" placeholder="Cari Kata" required class="border-solid border-2 border-slate-300 rounded-md w-64 py-2 pl-3 pr-9 focus:outline-[#D10B05]" />
=======
                        <input type="text" name="cari_kata" id="cari_kata" placeholder="Cari Kata" class="border-solid border-2 border-slate-300 rounded-md w-64 py-2 pl-3 pr-9 focus:outline-[#D10B05]" />
...
<<<<<<< HEAD
                <tr class="border-b-2 border-[#E6E6E6]">
                    ...
                    <td class="">Produknya Bagus Tapi Jelek</td>
                ...
                @foreach ($reviews as $r)
                    ...
                    <tr class="border-b-2 border-[#E6E6E6]">
                        ...
                        <td class="text-center">
                            <div class="rating rating-sm">
                                @for ($i = 1; $i <= 5; $i++)
                                    <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" {{ $r->ratings === $i ? 'checked' : '' }}/>
                                @endfor
                            </div>
                        </td>
                        <td class="text-center">
                            <!-- The button to open modal -->
                            <label for="my_modal_6" class="btn-hapus bg-[#D10B05] py-2 px-8 rounded-md font-semibold text-white hover:bg-[#9F0804] hover:border-[#9F0804] transition-all duration-200 ease-linear" data-id = "{{$r->_id}}">Hapus</label>
